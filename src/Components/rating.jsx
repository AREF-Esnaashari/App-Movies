...
export default function Rating({ setUserRating }) {
        ...
        {Array.from({ length: 10 }, (_, i) => {
          return (
            <Star
              ...
              onHandleTempRating={() => handleTempRating(i + 1)}
...
function Star({ onHandleRating, onHandleTempRating, onHandleLeave, full }) {
  return (
    <span
      className="rating"
      onClick={onHandleRating}
      onMouseEnter={onHandleTempRating}
